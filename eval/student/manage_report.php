        ...
        <div class="card card-outline card-primary">
              ...
              <div class="col-md-12">
                ...
                <!-- <div class="form-group">
                  ...
                  <select name="status" id="" class="custom-select" required>
                    <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Done Evaluate</option>
          ...
          <!-- <div class="card-footer">
            <div class="col-md-12 text-right">
              ...
              <button class="btn btn-secondary btn-sm" type="button" onclick="location.href='index.php?page=maintenance_report_list'">Cancel</button>
            </div>
          </div> -->
        </div>
      </div>
